...
class TicketsController extends Controller
{
    ...
    public function renderTicketTable(EloquentEngine $collection)
    {
        ...
        $collection->editColumn('subject', function ($ticket) use ($language) {
            return link_to_route(
                $language.Setting::grab('main_route') . '.show',
                $ticket->subject,
                $ticket->id
            );
        });
    ...
    public function update(PrepareTicketUpdateRequest $request, $id)
    {
        ...
        return redirect()->route($this->getLanguage().Setting::grab('main_route') . '.show', $id);
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route($this->getLanguage().Setting::grab('main_route') . '.index');
    }
