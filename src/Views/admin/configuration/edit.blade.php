      ...
      <div class="panel-heading">
        <h3>{{ trans('ticketit::admin.config-edit-title') }}
          <div class="panel-nav pull-right" style="margin-top: -7px;">          
              {!! link_to_route(
                  Request::segment(1).'.'.$setting->grab('admin_route').'.configuration.index',
...
{!! Form::model($configuration, ['route' => [Request::segment(1).'.'.$setting->grab('admin_route').'.configuration.update', $configuration->id], 'method' => 'patch']) !!}
