...
@include('ticketit::shared.header')
    <div class="well bs-component">
        {!! Form::open([
                        'route'=>Request::segment(1).'.'.$setting->grab('main_route').'.store',
                        'method' => 'POST',
            ...
            <div class="form-group">
                <div class="col-lg-10 col-lg-offset-2">
                    {!! link_to_route(Request::segment(1).'.'.$setting->grab('main_route').'.index', trans('ticketit::lang.btn-back'), null, ['class' => 'btn btn-default']) !!}
