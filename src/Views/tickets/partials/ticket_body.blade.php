                ...
                <span class="pull-right">
                    ...
                    @if($u->isAdmin())
                        @if($setting->grab('delete_modal_type') == 'builtin')
                            {!! link_to_route(
                                            Request::segment(1).'.'.$setting->grab('main_route').'.destroy', trans('ticketit::lang.btn-delete'), $ticket->id,
                                            [
...
{{-- // OR; Modal Window: 1/2 --}}
                            {!! Form::open(array(
                                    'route' => array(Request::segment(1).'.'.$setting->grab('main_route').'.destroy', $ticket->id),
                                    'method' => 'delete',
...
{{-- // END Modal Window: 1/2 --}}
            ...
            <div class="panel well well-sm">
                <div class="panel-body">
                    <div class="col-md-12">
                        <div class="col-md-6">
                            <p> <strong>{{ trans('ticketit::lang.owner') }}</strong>{{ trans('ticketit::lang.colon') }}{{ $ticket->user->full_name() }}</p>
                            <p>
                        ...
                        <div class="col-md-6">
                            <p> <strong>{{ trans('ticketit::lang.responsible') }}</strong>{{ trans('ticketit::lang.colon') }}{{ $ticket->agent->full_name() }}</p>
                            <p>
        ...
        {!! Form::open([
                        'method' => 'DELETE',
                        'route' => [
                                    Request::segment(1).'.'.$setting->grab('main_route').'.destroy',
                                    $ticket->id
                                    ],
