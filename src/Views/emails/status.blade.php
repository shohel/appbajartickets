                                    ...
                                    <table width="624" cellspacing="0" cellpadding="0" border="0">
                                        <tbody><tr>
                                            <td align="center" style="background-color:#f2f2f2;padding:55px 15px 55px 15px;border-radius:8px">
                                                ...
                                                <h2 style="text-align:center;font-size:20px;font-weight:100;font-family:Helvetica,Arial,sans-serif;color:#797979;margin:0px">Ticket Status Updated ! </h2>
                                                <br>
                                                <h3 style="text-align:left;font-size:14px;font-weight:100;font-family:Helvetica,Arial,sans-serif;color:#797979;margin:0px">Just letting you know  your inquiry <strong>{!! $ticket->subject !!} </strong> updated from {!! $original_ticket->status->name !!} to {!! $ticket->status->name !!}.</h3>
                                                <br>
